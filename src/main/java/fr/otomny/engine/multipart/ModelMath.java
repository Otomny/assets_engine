...
class Matrix3 {
  ...
  Matrix3(double x1, double x2, double x3, double y1, double y2, double y3,
  ...
  Matrix3 mul(Matrix3 matrix3) {
    double x1 =
        this.x1 * matrix3.x1 + this.x2 * matrix3.y1 + this.x3 * matrix3.z1;
    double x2 =
        this.x1 * matrix3.x2 + this.x2 * matrix3.y2 + this.x3 * matrix3.z2;
    double x3 =
        this.x1 * matrix3.x3 + this.x2 * matrix3.y3 + this.x3 * matrix3.z3;

    double y1 =
        this.y1 * matrix3.x1 + this.y2 * matrix3.y1 + this.y3 * matrix3.z1;
    double y2 =
        this.y1 * matrix3.x2 + this.y2 * matrix3.y2 + this.y3 * matrix3.z2;
    double y3 =
        this.y1 * matrix3.x3 + this.y2 * matrix3.y3 + this.y3 * matrix3.z3;

    double z1 =
        this.z1 * matrix3.x1 + this.z2 * matrix3.y1 + this.z3 * matrix3.z1;
    double z2 =
        this.z1 * matrix3.x2 + this.z2 * matrix3.y2 + this.z3 * matrix3.z2;
    double z3 =
        this.z1 * matrix3.x3 + this.z2 * matrix3.y3 + this.z3 * matrix3.z3;
...
public class ModelMath {
  ...
  static Vector toRadians(Vector vector) { return vector.multiply(DEGREE); }
  static Vector toDegrees(Vector vector) { return vector.multiply(RADIAN); }

  public static Vector rotate(Vector vector, Vector rotation) {
    Vector rot = toRadians(rotation);
