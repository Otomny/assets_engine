...
final public class Quaternion {
  ...
  public Vector toEuler() {
    ...
    return ModelMath.toDegrees(new Vector(vx, vy, vz));
  }
  ...
  Vector threeAxisRot(double r11, double r12, double r21, double r31,
                     double r32) {
  ...
  public Vector toEulerYZX() {
    Quaternion q = this;
    return ModelMath.toDegrees(
